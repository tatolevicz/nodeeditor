...
//
//FlowView::FlowView(QQuickItem *p): QQuickPaintedItem(p)
...
//{
////    setDragMode(QFlowView::ScrollHandDrag);
...
//
////    setTransformationAnchor(QFlowView::AnchorUnderMouse);
//
////    setCacheMode(QFlowView::CacheBackground);
////    setViewportUpdateMode(QFlowView::BoundingRectViewportUpdate);
//
//    setScaleRange(0.3, 2);
//
...
//}
//
////FlowView::FlowView(BasicGraphicsScene *scene, QWidget *parent)
////    : FlowView(parent)
////{
////    setScene(scene);
////}
...
//}
//
////void FlowView::setScene(BasicGraphicsScene *scene)
////{
////    QFlowView::setScene(scene);
//
////    {
////        // setup actions
...
////                &QAction::triggered,
////                this,
////                &FlowView::onDeleteSelectedObjects);
//
...
////                &QAction::triggered,
////                this,
////                &FlowView::onDuplicateSelectedObjects);
//
...
////                &QAction::triggered,
////                this,
////                &FlowView::onCopySelectedObjects);
//
...
////        connect(_pasteAction, &QAction::triggered, this, &FlowView::onPasteObjects);
//
...
////{
////    if (itemAt(event->pos())) {
////        QFlowView::contextMenuEvent(event);
////        return;
////    }
//
...
//}
//
//double FlowView::getScale() const
//{
...
//}
//
//void FlowView::setScaleRange(ScaleRange range)
//{
...
//}
//
//void FlowView::onDeleteSelectedObjects()
//{
////    nodeScene()->undoStack().push(new DeleteCommand(nodeScene()));
//}
//
//void FlowView::onDuplicateSelectedObjects()
//{
...
//}
//
//void FlowView::onCopySelectedObjects()
//{
////    nodeScene()->undoStack().push(new CopyCommand(nodeScene()));
//}
//
//void FlowView::onPasteObjects()
//{
//    QPointF const pastePosition = scenePastePosition();
////    nodeScene()->undoStack().push(new PasteCommand(nodeScene(), pastePosition));
//}
...
////    switch (event->key()) {
////    case Qt::Key_Shift:
////        setDragMode(QFlowView::RubberBandDrag);
////        break;
//
////    default:
////        break;
...
////        break;
////    }
////    QFlowView::keyReleaseEvent(event);
//}
//
//void FlowView::mousePressEvent(QMouseEvent *event)
//{
////    QFlowView::mousePressEvent(event);
...
//{
////    QFlowView::mouseMoveEvent(event);
...
//{
//    QFlowView::drawBackground(painter, r);
//
...
//{
//    QFlowView::showEvent(event);
//
//    centerScene();
//}
//
//BasicGraphicsScene *FlowView::nodeScene()
//{
//    return dynamic_cast<BasicGraphicsScene *>(scene());
//}
//
//QPointF FlowView::scenePastePosition()
//{
